        ...
        <div class="card-body p-4">
            <div class="row align-items-center  mb-3">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h5 class="card-title fw-semibold mb-0">Edit Issue</h5>
                    <a href="<?= site_url('issue') ?>" class="btn btn-secondary rounded-2 fw-semibold">
                        <i class="ti ti-arrow-left"></i> Back
                    </a>
                </div>

                <form action="<?= site_url('issue/edit/' . $issue['id'] . '/save') ?>" method="POST" enctype="multipart/form-data" id="issueForm">
                    <?= csrf_field() ?>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="message" name="message" class="form-control" rows="3" required><?= old('message', $issue['message'] ?? '') ?></textarea>
                    </div>

                    <div class="mb-3">
                        <label for="issue" class="form-label fw-semibold">Issue</label>
                        <textarea id="issue" name="issue" class="form-control" rows="3" required><?= old('issue', $issue['issue'] ?? '') ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="photoPreviewContainer" class="mt-2">
                            <img id="photoPreview" src="<?= $issue['path_photo'] ?>" alt="Photo Preview" class="img-thumbnail" style="max-width: 250px;">
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div id="videoPreviewContainer" class="mt-2">
                            <video id="videoPreview" src="<?= $issue['path_video'] ?>" controls style="height: auto;">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <button type="submit" id="submitBtn" class="btn btn-primary fw-semibold">
                            <i class="ti ti-save"></i> Edit
                        </button>
                    </div>
                </form>
...
<?php include(__DIR__ . '/../../scripts/edit_issue-script.php'); ?>
<?= $this->endSection() ?>